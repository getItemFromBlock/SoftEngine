                                          ...
                                          VulkanQueue& graphicsQueue)
{
    ...
    VulkanUtils::TransitionImageLayout(commandPool, graphicsQueue, VK_IMAGE_LAYOUT_UNDEFINED,
        VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL, m_device, m_image, 6);

    CopyBufferToImage(stagingBuffer, m_image, faceSize, faceSize, 6, commandPool, graphicsQueue);

    VulkanUtils::TransitionImageLayout(commandPool, graphicsQueue, VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL,
        VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL, m_device, m_image, 6);
                                        ...
                                        VulkanQueue& graphicsQueue)
{
    ...
    VulkanUtils::TransitionImageLayout(commandBuffer, graphicsQueue, VK_IMAGE_LAYOUT_UNDEFINED, 
                          VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL, m_device, m_image);
    CopyBufferToImage(commandBuffer, graphicsQueue, stagingBuffer, p_width, p_height);
    VulkanUtils::TransitionImageLayout(commandBuffer, graphicsQueue, VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL,
                          VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL, m_device, m_image);
    
    GenerateMipmaps(commandBuffer, graphicsQueue);
